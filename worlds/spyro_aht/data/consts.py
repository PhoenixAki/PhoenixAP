...
class G5SE7D(AddressList):
    ...
    p_GEMS_IN_LOGIC = 0x803d9038
    p_GEMS_AVAILABLE = 0x803d903c
    p_UT_ENABLED = 0x803d9040
    p_TRAP = 0x803d9041
    p_TRAP_DATA = 0x803d9044
    p_XLS_SHOP_SHEETCOUNT_ALWAYS_1 = 0x803d9048
    p_XLS_SHOP_SHEET_OFFSET_ALWAYS_4 = 0x803d904c
    p_XLS_SHOP_ROWCOUNT = 0x803d9050
    p_XLS_SHOP_ITEMS = 0x803d9054
    p_SHOP_TEXT = 0x803d97f4
    ...
    g_GEMS_IN_LOGIC = 0x80467d74
    g_GEMS_AVAILABLE = 0x80467d78
    g_UT_ENABLED = 0x80467d7c
    g_TRAP = 0x80467d7d
    g_TRAP_DATA = 0x80467d80
    g_XLS_SHOP_SHEETCOUNT_ALWAYS_1 = 0x80467d84
    g_XLS_SHOP_SHEET_OFFSET_ALWAYS_4 = 0x80467d88
    g_XLS_SHOP_ROWCOUNT = 0x80467d8c
    g_XLS_SHOP_ITEMS = 0x80467d90
    g_SHOP_TEXT = 0x80468530

    n_AP_NOTIFICATION_COLOR = 0x8029e1dc
    n_AP_NOTIFICATION_TIMER = 0x8029e1e0
    n_AP_NOTIFICATION_TEXT_BUFFER = 0x8029e1e4
...
class G5SP7D(AddressList):
    ...
    p_GEMS_IN_LOGIC = 0x803d9a88
    p_GEMS_AVAILABLE = 0x803d9a8c
    p_UT_ENABLED = 0x803d9a90
    p_TRAP = 0x803d9a91
    p_TRAP_DATA = 0x803d9a94
    p_XLS_SHOP_SHEETCOUNT_ALWAYS_1 = 0x803d9a98
    p_XLS_SHOP_SHEET_OFFSET_ALWAYS_4 = 0x803d9a9c
    p_XLS_SHOP_ROWCOUNT = 0x803d9aa0
    p_XLS_SHOP_ITEMS = 0x803d9aa4
    p_SHOP_TEXT = 0x803da244
    ...
    g_GEMS_IN_LOGIC = 0x8046884c
    g_GEMS_AVAILABLE = 0x80468850
    g_UT_ENABLED = 0x80468854
    g_TRAP = 0x80468855
    g_TRAP_DATA = 0x80468858
    g_XLS_SHOP_SHEETCOUNT_ALWAYS_1 = 0x8046885c
    g_XLS_SHOP_SHEET_OFFSET_ALWAYS_4 = 0x80468860
    g_XLS_SHOP_ROWCOUNT = 0x80468864
    g_XLS_SHOP_ITEMS = 0x80468868
    g_SHOP_TEXT = 0x80469008

    n_AP_NOTIFICATION_COLOR = 0x8029ea4c
    n_AP_NOTIFICATION_TIMER = 0x8029ea50
    n_AP_NOTIFICATION_TEXT_BUFFER = 0x8029ea54
